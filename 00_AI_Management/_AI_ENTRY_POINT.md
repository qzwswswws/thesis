...
### 🪶 [A1. 文本自然化与去模板化任务]
当用户要求你“降机械感 / 去 AI 味 / 做自然化改写 / 降低 AIGC 痕迹”时：
- **必须读取**: `00_AI_Management\Prompt_Library\AIGC_Optimization_Protocol.md` (指导如何通过真实、克制、可追溯的改写降低模板感，而不是靠投机技巧规避检测)
- **建议同时读取**: `00_AI_Management\Prompt_Library\Writing_Quality_Standards.md` (防止自然化改写把正文带偏成口语化或文学化)
