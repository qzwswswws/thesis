...
%
%\documentclass[doctor,twoside,biber,resumebib,fz]{nudtpaper} %明评存档
\documentclass[doctor,biber,resumebib,fz,spline]{nudtpaper} %查重
% \documentclass[doctor,twoside,biber,resumebib,fz，anon]{nudtpaper}
% \documentclass[doctor,twoside,biber,fz,resumebib, anon, blind]{nudtpaper}
...
\confidentiality{公开}
\UDC{004}
\title{多源脑电信号的生成式建模方法及应用}
% \displaytitle{国防科技大学学位论文\LaTeX{}模板}
\author{张壹帆}
\zhdate{\zhtoday}
\entitle{Generative Modeling Methods and Applications for Multi-source EEG Signals}
\enauthor{Zhang Yifan}
\endate{\entoday}
\subject{控制科学与工程}
\ensubject{Control Science and Engineering}
\researchfield{脑机智能融合技术}
\supervisor{胡德文\quad{}教授}
\cosupervisor{曾令李\quad{}教授} % 没有就空着
\ensupervisor{Prof. Hu Dewen}
\encosupervisor{Prof. Zeng Ling-Li} % 没有就空着
\papertype{工学}
